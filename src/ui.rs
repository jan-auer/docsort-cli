        ...
        match app.state {
            AppState::Browsing => {
                let text = if app.current_file_is_moved() {
                    "\u{2191}\u{2193} navigate  \u{21b5} file  u undo  Space preview  o open  f finder  ^C quit"
                } else {
                    "\u{2191}\u{2193} navigate  \u{21b5} file  d delete  Space preview  o open  f finder  ^C quit"
                };
